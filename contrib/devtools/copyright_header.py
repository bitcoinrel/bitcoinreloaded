...
EXCLUDE = [
    # auto generated:
    'src/qt/bitcoinreloadedstrings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    r"Satoshi Nakamoto",
    r"The BitcoinReloaded Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a bitcoinreloaded source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BitcoinReloaded Core developers'
...
Arguments:
    <file> - A source file in the bitcoinreloaded repository.
"""
