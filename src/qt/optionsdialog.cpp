    ...
    mapper(nullptr)
{
    ...
    ui->bitcoinreloadedAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitcoinreloadedAtStartup);
    ...
    ui->bitcoinreloadedAtStartup->setToolTip(ui->bitcoinreloadedAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitcoinreloadedAtStartup->setText(ui->bitcoinreloadedAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitcoinReloadedConfButton->setToolTip(ui->openBitcoinReloadedConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BitcoinReloadedUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinreloadedAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitcoinReloadedConfButton_clicked()
{
    ...
    if (!GUIUtil::openBitcoinReloadedConf())
