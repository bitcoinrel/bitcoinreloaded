...
"""Verify that starting bitcoinreloaded with -h works as expected."""

from test_framework.test_framework import BitcoinReloadedTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinReloadedTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinreloaded with -h for help text")
        ...
        self.log.info("Start bitcoinreloaded with -version for version information")
        ...
        self.log.info("Start bitcoinreloadedd with -fakearg to make sure it does not start")
