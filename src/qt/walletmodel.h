...
#ifndef BITCOINRELOADED_QT_WALLETMODEL_H
#define BITCOINRELOADED_QT_WALLETMODEL_H
...
/** Interface to BitcoinReloaded wallet from Qt view code. */
...
#endif // BITCOINRELOADED_QT_WALLETMODEL_H
