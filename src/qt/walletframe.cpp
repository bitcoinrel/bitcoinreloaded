...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, BitcoinReloadedGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &BitcoinReloadedGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &BitcoinReloadedGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &BitcoinReloadedGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &BitcoinReloadedGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &BitcoinReloadedGUI::updateWalletStatus);
    connect(gui, &BitcoinReloadedGUI::setPrivacy, walletView, &WalletView::setPrivacy);
