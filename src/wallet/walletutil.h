...
#ifndef BITCOINRELOADED_WALLET_WALLETUTIL_H
#define BITCOINRELOADED_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bitcoinreloaded from opening the wallet, thinking it was newly created, and
...
#endif // BITCOINRELOADED_WALLET_WALLETUTIL_H
