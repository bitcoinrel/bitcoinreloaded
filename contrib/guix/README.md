# Bootstrappable BitcoinReloaded Core Builds

This directory contains the files necessary to perform bootstrappable BitcoinReloaded
Core builds.
...
- 24GB of free disk space on the partition that the BitcoinReloaded Core git repository
  resides in
...
For a BitcoinReloaded Core depends development environment, simply invoke
...
From the top of a clean BitcoinReloaded Core repository:
...
To use dongcarl's substitute server for BitcoinReloaded Core builds after having
