...
By default, bitcoinreloadedd will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinReloadedTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitcoinreloadedd from writing mempool.dat to disk. Verify that `savemempool` fails")
