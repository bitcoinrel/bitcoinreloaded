    ...
    platformStyle(_platformStyle)
{
    ...
    // normal bitcoinreloaded address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying bitcoinreloaded address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &BitcoinReloadedAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
