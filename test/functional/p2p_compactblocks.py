...
# TestP2PConn: A peer we use to send messages to bitcoinreloadedd, and store responses.
...
class CompactBlocksTest(BitcoinReloadedTestFramework):
    ...
    # This test actually causes bitcoinreloadedd to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoinreloadedd's choice of nonce.
    ...
    # Test that bitcoinreloadedd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for bitcoinreloadedd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # bitcoinreloadedd will not send blocktxn responses for blocks whose height is
