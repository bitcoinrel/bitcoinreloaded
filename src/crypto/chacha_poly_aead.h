...
#ifndef BITCOINRELOADED_CRYPTO_CHACHA_POLY_AEAD_H
#define BITCOINRELOADED_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bitcoinreloaded.
 *
 ...
 *
 * The chacha20-poly1305@bitcoinreloaded combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitcoinreloaded cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitcoinreloaded are relatively fast in
...
#endif // BITCOINRELOADED_CRYPTO_CHACHA_POLY_AEAD_H
