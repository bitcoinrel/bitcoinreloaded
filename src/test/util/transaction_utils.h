...
#ifndef BITCOINRELOADED_TEST_UTIL_TRANSACTION_UTILS_H
#define BITCOINRELOADED_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // BITCOINRELOADED_TEST_UTIL_TRANSACTION_UTILS_H
