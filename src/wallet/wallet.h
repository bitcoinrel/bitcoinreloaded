...
#ifndef BITCOINRELOADED_WALLET_WALLET_H
#define BITCOINRELOADED_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinreloaded node, and set to 0 for transactions that were created
...
#endif // BITCOINRELOADED_WALLET_WALLET_H
