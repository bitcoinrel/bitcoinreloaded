...
#ifndef BITCOINRELOADED_TEST_SCRIPTNUM10_H
#define BITCOINRELOADED_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitcoinReloaded Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINRELOADED_TEST_BIGNUM_H
