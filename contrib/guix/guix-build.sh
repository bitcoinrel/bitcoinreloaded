...
# Deterministically build BitcoinReloaded Core for HOSTs (overridable by environment)
...
for host in ${HOSTS=x86_64-linux-gnu arm-linux-gnueabihf aarch64-linux-gnu riscv64-linux-gnu x86_64-w64-mingw32}; do
    ...
    (
        ...
        #     same exact path (e.g. mapping '/home/satoshi/bitcoinreloaded/' to
        #     '/home/satoshi/bitcoinreloaded/'). This means that the $PWD inside the
        ...
        #                      according to SPEC
        #
        #   --share="$PWD"=/bitcoinreloaded
        #
        #                     maps our current working directory to /bitcoinreloaded
        ...
        #     container so that we have something to build. '/bitcoinreloaded' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                      ...
                                      bash -c "cd /bitcoinreloaded && bash contrib/guix/libexec/build.sh"
    )
