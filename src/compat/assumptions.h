...
#ifndef BITCOINRELOADED_COMPAT_ASSUMPTIONS_H
#define BITCOINRELOADED_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "BitcoinReloaded cannot be compiled without assertions."
#endif
...
#endif // BITCOINRELOADED_COMPAT_ASSUMPTIONS_H
