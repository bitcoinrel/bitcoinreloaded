...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitcoinReloadedTestFramework
    pass


class ExampleTest(BitcoinReloadedTestFramework):
    # Each functional test is a subclass of the BitcoinReloadedTestFramework class.
    ...
    def custom_method(self):
        ...
        BitcoinReloadedTestFramework class so other tests can use it."""
