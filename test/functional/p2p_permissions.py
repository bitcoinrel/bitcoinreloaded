...
class P2PPermissionsTests(BitcoinReloadedTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].bitcoinreloadedconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].bitcoinreloadedconf, 'w', encoding="utf8") as f:
            f.write(newText)
