...
#ifndef BITCOINRELOADED_UTIL_REF_H
#define BITCOINRELOADED_UTIL_REF_H
 ...
 * (https://github.com/bitcoinreloaded/bitcoinreloaded/issues/16684)
 */
class Ref
{
public:
...
#endif // BITCOINRELOADED_UTIL_REF_H
