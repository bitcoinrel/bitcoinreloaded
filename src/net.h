...
#ifndef BITCOINRELOADED_NET_H
#define BITCOINRELOADED_NET_H
...
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on BitcoinReloaded’s Peer-to-Peer Network")
