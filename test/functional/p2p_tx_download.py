...
class TxDownloadTest(BitcoinReloadedTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new bitcoinreloadedd instances, as setting mocktimes has long-term effects on when
