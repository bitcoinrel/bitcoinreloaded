...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bitcoinreloaded repository."
  exit 1
fi
...
# See https://github.com/bitcoinreloaded/bitcoinreloaded/issues/16064
...
echo 'When compiling bitcoinreloadedd, run `./configure` in the following way:'
echo
