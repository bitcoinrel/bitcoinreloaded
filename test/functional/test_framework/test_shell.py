...
class TestShell:
    """Wrapper Class for BitcoinReloadedTestFramework.

    The TestShell class extends the BitcoinReloadedTestFramework
    ...
    class __TestShell(BitcoinReloadedTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitcoinReloadedTestFramework child class.
            self.num_nodes = 1
