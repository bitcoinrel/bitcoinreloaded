...
// bitcoinreloaded includes.
#include <..\src\script\bitcoinreloadedconsensus.h>
...
int main()
{
    std::cout << "bitcoinreloadedconsensus version: " << bitcoinreloadedconsensus_version() << std::endl;
    ...
    auto op0Result = bitcoinreloadedconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, bitcoinreloadedconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
