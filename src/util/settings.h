...
#ifndef BITCOINRELOADED_UTIL_SETTINGS_H
#define BITCOINRELOADED_UTIL_SETTINGS_H
...
//!       https://github.com/bitcoinreloaded/bitcoinreloaded/pull/15934/files#r337691812)
...
#endif // BITCOINRELOADED_UTIL_SETTINGS_H
