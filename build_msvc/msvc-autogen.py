...
libs = [
    'libbitcoinreloaded_cli',
    'libbitcoinreloaded_common',
    'libbitcoinreloaded_crypto',
    'libbitcoinreloaded_server',
    'libbitcoinreloaded_util',
    'libbitcoinreloaded_wallet_tool',
    'libbitcoinreloaded_wallet',
    'libbitcoinreloaded_zmq',
    'bench_bitcoinreloaded',
    'libtest_util',
]
...
def main():
    parser = argparse.ArgumentParser(description='BitcoinReloaded-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/bitcoinreloaded_config.h'), os.path.join(SOURCE_DIR, 'config/bitcoinreloaded-config.h'))
