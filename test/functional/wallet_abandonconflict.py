...
class AbandonConflictTest(BitcoinReloadedTestFramework):
    ...
    def run_test(self):
        ...
        inputs = []
        # spend 10btcr outputs from txA and txB
        ...
        # Identify the 14.99998btcr output
