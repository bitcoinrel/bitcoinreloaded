...
#ifndef BITCOINRELOADED_UTIL_MESSAGE_H
#define BITCOINRELOADED_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's bitcoinreloaded address, it must refer to a public key.
...
#endif // BITCOINRELOADED_UTIL_MESSAGE_H
