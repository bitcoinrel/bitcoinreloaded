...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinreloadedcore.org", "www.bitcoinreloadedcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoinreloadedcore.org]", "www.bitcoinreloadedcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoinreloadedcore.org:80", "www.bitcoinreloadedcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinreloadedcore.org]:80", "www.bitcoinreloadedcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:11268", "127.0.0.1", 11268));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:11268", "127.0.0.1", 11268));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:11268", "::ffff:127.0.0.1", 11268));
    BOOST_CHECK(TestSplitHost("[::]:11268", "::", 11268));
    BOOST_CHECK(TestSplitHost("::11268", "::11268", -1));
    BOOST_CHECK(TestSplitHost(":11268", "", 11268));
    BOOST_CHECK(TestSplitHost("[]:11268", "", 11268));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:11268", "127.0.0.1:11268"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:11268", "[::]:11268"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
