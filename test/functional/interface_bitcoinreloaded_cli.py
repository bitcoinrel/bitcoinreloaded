...
# The block reward of coinbaseoutput.nValue (50) BTCR/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 BTCR/block.
BLOCKS = 101
...
class TestBitcoinReloadedCli(BitcoinReloadedTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bitcoinreloaded-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and bitcoinreloaded-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 BTCR) to the default wallet.
            ...
            # Test bitcoinreloaded-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test bitcoinreloaded-cli -generate with -rpcwallet in multiwallet mode.
