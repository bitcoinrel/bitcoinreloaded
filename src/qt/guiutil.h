...
#ifndef BITCOINRELOADED_QT_GUIUTIL_H
#define BITCOINRELOADED_QT_GUIUTIL_H
...
/** Utility functions used by the BitcoinReloaded Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bitcoinreloaded:" URI into recipient object, return true on successful parsing
...
#endif // BITCOINRELOADED_QT_GUIUTIL_H
