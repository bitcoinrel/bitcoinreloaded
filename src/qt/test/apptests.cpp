...
//! Entry point for BitcoinReloadedApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitcoinReloadedApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitcoinReloadedGUI tests.
void AppTests::guiTests(BitcoinReloadedGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitcoinReloadedGUI::consoleShown, this, &AppTests::consoleTests);
