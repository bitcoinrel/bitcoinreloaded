...
#ifndef BITCOINRELOADED_QT_SENDCOINSDIALOG_H
#define BITCOINRELOADED_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending bitcoinreloadeds */
...
#endif // BITCOINRELOADED_QT_SENDCOINSDIALOG_H
