...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/BitcoinReloaded
else
  DOCKER_EXEC echo \> \$HOME/.bitcoinreloaded
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/bitcoinreloaded/bitcoinreloaded/pull/18288#discussion_r433189350 for
  # details.
